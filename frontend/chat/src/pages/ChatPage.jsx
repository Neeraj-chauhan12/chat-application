...
const ChatPage = () => {
  ...
  return (
    <div className="h-screen w-screen flex md:flex-row flex-col text-white relative">
      ...
      <div
        className={`md:w-[20%] w-full min-h-screen md:h-full bg-gradient-to-r from-gray-500 to-gray-700 border-r-2 border-gray-300 ${
      ...
      >
        ...
        <div className="md:hidden flex justify-end p-2 absolute top-2 right-2 z-10">
          <button
            ...
            className="rounded-full bg-gray-800 p-1 shadow-lg"
          >
      ...
      <div
        className={`md:w-[60%] w-full md:h-full min-h-full bg-gradient-to-r from-gray-700 to-gray-900 md:border-r-2 border-gray-300 ${
      ...
      >
        ...
        <div className="md:hidden flex items-center p-2 relative">
          <button
            onClick={handleBack}
            className="bg-gray-800 text-white px-2 py-2 absolute top-10  rounded-full mr-2"
          >
            <IoArrowBackSharp />
          </button>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl  w-[90vw] max-w-md relative">
            <button
              ...
              className="absolute top-5 right-2 bg-gray-500 rounded-full text-xl text-white font-bold"
            >
              <IoMdClose />
            </button>
            <Profile />
